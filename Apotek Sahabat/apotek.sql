...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2023 at 02:33 PM
...
('OBT12346', 'Antibiotik', 'Tablet', 'Dewasa', 7, '8.000');
...
('PGW112', 'Fira', 'Perempuan', 'Bekasi', 'S2', 'Apoteker', '4.000.000');
...
INSERT INTO `user` (`username`, `nmUser`, `password`, `status`) VALUES
('admin1', 'Ezra Faira', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Admin'),
('pegawai1', 'Elfira', 'a431ba54c55ae2cb91be1785398ecd595ca96b7a', 'Pegawai');
