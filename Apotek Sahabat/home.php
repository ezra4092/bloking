...
<body align='center'>
    <div class="container">
        <nav class="navbar navbar-expand-sm navbar-light bg-Light pe-5" style="margin-bottom: 25px;">
            <div class="container-fluid">
                <img src="assets/img/remove.png" alt="Logo" width="30" height="30" class="d-inline-block align-text-top">
                <a class="navbar-brand ms-2" href="#">Apotek Sahabat</a>
  ...
  <button class="btn btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <main align="center" style="margin-bottom: 70px;">
            <h2>Halo, <?php echo $_SESSION['nmUser']; ?></h2>
            <h4 style="margin-bottom: 40px;">Selamat Datang di Halaman Utama</h2>
