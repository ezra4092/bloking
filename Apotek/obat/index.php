                    ...
                    <tbody align="center">
                        ...
                        ?>
                            <tr align="center">
                                ...
                                <td class="align-middle"><a data-href="#" class="btn btn-warning btn-sm update" data-bs-toggle="modal" data-bs-target="#editdata" data-kdObat="<?= $row['kdObat'] ?>" data-nmObat="<?= $row['nmObat'] ?>" data-kategori="<?= $row['kategori'] ?>"><i class="fas fa-pen"></i></a> <a href="konfigurasi.php?delete=<?= $row['kdObat']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a></td>
                            </tr>
                    </tbody>
                <?php } ?>
                </table>
    ...
    <div class="modal fade" id="editdata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="col-sm">
                        <input type="text" name="kdObat" class="form-control" id="kdObat_u" readonly>
                    </div>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
