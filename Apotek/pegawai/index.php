...
<body>
    <div class="container">
        <nav class="navbar navbar-expand-sm navbar-light bg-light" style="margin-bottom: 50px; padding-bottom: 10px;">
            ...
            <tbody align="center">
                ...
                ?>
                    <tr align="center">
                        ...
                        <td class="align-middle"><a data-href="#" class="btn btn-warning btn-sm update" data-bs-toggle="modal" data-bs-target="#editdata" data-idPegawai="<?= $row['idPegawai'] ?>" data-nmPegawai="<?= $row['nmPegawai'] ?>" data-alamat="<?= $row['alamat'] ?>"><i class="fas fa-pen"></i></a> <a href="konfigurasi.php?delete=<?= $row['idPegawai']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a></td>
                    </tr>
            </tbody>
        <?php } ?>
        </table>
    ...
    <div class="modal fade" id="editdata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="col-sm">
                        <input type="text" name="idPegawai" class="form-control" id="idPegawai_u" readonly>
                    </div>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
